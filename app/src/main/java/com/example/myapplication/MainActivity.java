...
public class MainActivity extends AppCompatActivity  implements OnMapReadyCallback, DirectionFinderListener {
    ...
    private Button btnFindPath,gps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFindPath = findViewById(R.id.jalur);
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map);
        mapFragment.getMapAsync(this);

        btnFindPath = (Button) findViewById(R.id.jalur);
        etOrigin = (EditText) findViewById(R.id.etOrigin);

        final Bundle bundle = getIntent().getExtras();
        String terima_nama_wisata = bundle.getString("kirim_nama_wisata");
        etDestination.setText(terima_nama_wisata);
